...
STAB = {
    ...
    'level_req': 1, 'stamina_cost': 15, 'cooldown': 0.0, 'casting_time': 0.0, 'target_type': 'single', 'range': 'melee',
...
PUNCTURE = {
    ...
    'level_req': 4, 'stamina_cost': 20, 'cooldown': 6.0, 'casting_time': 0.0, 'target_type': 'single', 'range': 'melee',
...
QUICK_STEP = {
    ...
    'level_req': 8, 'stamina_cost': 10, 'cooldown': 10.0, 'casting_time': 0.0, 'target_type': 'movement', 'range': 8,
...
GOUGE = {
    ...
    'level_req': 12, 'stamina_cost': 25, 'cooldown': 15.0, 'casting_time': 0.0, 'target_type': 'single', 'range': 'melee',
    'effects': [
...
FAN_OF_KNIVES = {
    ...
    'level_req': 16, 'stamina_cost': 35, 'cooldown': 8.0, 'casting_time': 0.0, 'target_type': 'cone', 'range': 8,
...
RUPTURE = {
    ...
    'level_req': 20, 'stamina_cost': 30, 'cooldown': 4.0, 'casting_time': 0.0, 'target_type': 'single', 'range': 'melee',
...
EXPOSE_WEAKNESS = {
    ...
    'level_req': 24, 'stamina_cost': 20, 'cooldown': 20.0, 'casting_time': 0.0, 'target_type': 'single', 'range': 'melee',
...
SHADOW_STRIKE = {
    ...
    'level_req': 28, 'stamina_cost': 40, 'cooldown': 12.0, 'casting_time': 0.0, 'target_type': 'single', 'range': 'melee',
...
POISONED_BLADE = {
    ...
    'level_req': 32, 'stamina_cost': 50, 'cooldown': 45.0, 'casting_time': 0.0, 'target_type': 'self', 'range': 0,
...
HEMORRHAGE = {
    ...
    'level_req': 36, 'stamina_cost': 0, 'cooldown': 0.0, 'casting_time': 0.0, 'target_type': 'self', 'range': 0,
...
FLURRY_OF_STEEL = {
    ...
    'level_req': 40, 'stamina_cost': 60, 'cooldown': 20.0, 'casting_time': 0.0, 'target_type': 'single', 'range': 'melee',
...
CRIPPLING_POISON = {
    ...
    'level_req': 44, 'stamina_cost': 50, 'cooldown': 45.0, 'casting_time': 0.0, 'target_type': 'self', 'range': 0,
...
BLOODLETTING = {
    ...
    'level_req': 48, 'stamina_cost': 40, 'cooldown': 90.0, 'casting_time': 0.0, 'target_type': 'single', 'range': 'melee',
...
EVISCERATE = {
    ...
    'level_req': 52, 'stamina_cost': 75, 'cooldown': 10.0, 'casting_time': 0.0, 'target_type': 'single', 'range': 'melee',
...
VANISH = {
    ...
    'level_req': 56, 'stamina_cost': 30, 'cooldown': 180.0, 'casting_time': 0.0, 'target_type': 'self', 'range': 0,
...
EXSANGUINATE = {
    ...
    'level_req': 60, 'stamina_cost': 100, 'cooldown': 120.0, 'casting_time': 1.0, 'target_type': 'single', 'range': 'melee',
    'effects': [
