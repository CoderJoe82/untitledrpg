...
THRUST = {
    ...
    'level_req': 1, 'stamina_cost': 18, 'cooldown': 0.0, 'casting_time': 0.0, 'target_type': 'single', 'range': 'melee_long', # Special range
...
PRECISION_STRIKE = {
    ...
    'level_req': 4, 'stamina_cost': 25, 'cooldown': 6.0, 'casting_time': 0.5, 'target_type': 'single', 'range': 'melee_long',
...
SWEEP = {
    ...
    'level_req': 8, 'stamina_cost': 30, 'cooldown': 10.0, 'casting_time': 0.0, 'target_type': 'cone', 'range': 'melee',
...
BRACE = {
    ...
    'level_req': 12, 'stamina_cost': 10, 'cooldown': 25.0, 'casting_time': 0.0, 'target_type': 'self', 'range': 0,
...
SKEWER = {
    ...
    'level_req': 16, 'stamina_cost': 25, 'cooldown': 12.0, 'casting_time': 0.0, 'target_type': 'single', 'range': 'melee_long',
...
KEEN_EDGE = {
    ...
    'level_req': 20, 'stamina_cost': 0, 'cooldown': 0.0, 'casting_time': 0.0, 'target_type': 'self', 'range': 0,
...
LUNGE = {
    ...
    'level_req': 24, 'stamina_cost': 35, 'cooldown': 15.0, 'casting_time': 0.0, 'target_type': 'line', 'range': 12,
...
LEG_SWEEP = {
    ...
    'level_req': 28, 'stamina_cost': 20, 'cooldown': 30.0, 'casting_time': 0.0, 'target_type': 'single', 'range': 'melee',
...
DEADLY_CALM = {
    ...
    'level_req': 32, 'stamina_cost': 30, 'cooldown': 90.0, 'casting_time': 0.0, 'target_type': 'self', 'range': 0,
...
PHALANX_BREAKER = {
    ...
    'level_req': 40, 'stamina_cost': 45, 'cooldown': 20.0, 'casting_time': 1.0, 'target_type': 'single', 'range': 'melee_long',
...
VAULT = {
    ...
    'level_req': 44, 'stamina_cost': 15, 'cooldown': 25.0, 'casting_time': 0.0, 'target_type': 'aoe_ground', 'range': 20,
...
HEARTSEEKER = {
    ...
    'level_req': 48, 'stamina_cost': 50, 'cooldown': 15.0, 'casting_time': 1.0, 'target_type': 'single', 'range': 'melee_long',
...
DRAGONSONG_DIVE = {
    ...
    'level_req': 60, 'stamina_cost': 100, 'cooldown': 120.0, 'casting_time': 2.0, 'target_type': 'single', 'range': 30,
