...
MIGHTY_SWING = {
    ...
    'level_req': 1, 'stamina_cost': 25, 'cooldown': 0.0, 'casting_time': 0.0, 'target_type': 'single', 'range': 'melee',
...
SWEEPING_CLEAVE = {
    ...
    'level_req': 4, 'stamina_cost': 30, 'cooldown': 8.0, 'casting_time': 0.0, 'target_type': 'cone', 'range': 'melee',
...
LACERATE = {
    ...
    'level_req': 12, 'stamina_cost': 20, 'cooldown': 10.0, 'casting_time': 0.0, 'target_type': 'single', 'range': 'melee',
...
OVERPOWER = {
    ...
    'level_req': 16, 'stamina_cost': 15, 'cooldown': 1.0, 'casting_time': 0.0, 'target_type': 'single', 'range': 'melee',
...
WARBREAKER = {
    ...
    'level_req': 24, 'stamina_cost': 40, 'cooldown': 20.0, 'casting_time': 0.0, 'target_type': 'line', 'range': 15,
    'effects': [
...
MORTAL_STRIKE = {
    ...
    'level_req': 28, 'stamina_cost': 35, 'cooldown': 12.0, 'casting_time': 0.0, 'target_type': 'single', 'range': 'melee',
    'effects': [
...
RECKLESSNESS = {
    ...
    'level_req': 36, 'stamina_cost': 20, 'cooldown': 120.0, 'casting_time': 0.0, 'target_type': 'self', 'range': 0,
...
SHOCKWAVE = {
    ...
    'level_req': 44, 'stamina_cost': 40, 'cooldown': 30.0, 'casting_time': 0.0, 'target_type': 'cone', 'range': 12,
    'effects': [
...
EXECUTE = {
    ...
    'level_req': 48, 'stamina_cost': 50, 'cooldown': 5.0, 'casting_time': 0.0, 'target_type': 'single', 'range': 'melee',
...
BLADESTORM = {
    ...
    'level_req': 52, 'stamina_cost': 100, 'cooldown': 90.0, 'casting_time': 0.0, 'target_type': 'self', 'range': 0,
    'effects': [
...
TITANS_GRIP = {
    ...
    'level_req': 56, 'stamina_cost': 0, 'cooldown': 0.0, 'casting_time': 0.0, 'target_type': 'self', 'range': 0,
...
DEATH_SENTENCE = {
    ...
    'level_req': 60, 'stamina_cost': 80, 'cooldown': 120.0, 'casting_time': 1.5, 'target_type': 'single', 'range': 'melee',
