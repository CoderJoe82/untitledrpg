...
HEAVY_SLAM = {
    ...
    'level_req': 1, 'skill_req': 1, 'stamina_cost': 26, 'cooldown': 0.0, 'casting_time': 0.0, 'target_type': 'single', 'range': 'melee',
...
SUNDERING_BLOW = {
    ...
    'level_req': 4, 'skill_req': 5, 'stamina_cost': 20, 'cooldown': 4.0, 'casting_time': 0.0, 'target_type': 'single', 'range': 'melee',
...
GROUND_TREMOR = {
    ...
    'level_req': 8, 'skill_req': 10, 'stamina_cost': 35, 'cooldown': 12.0, 'casting_time': 0.0, 'target_type': 'self', 'range': 0,
    'effects': [
...
BULL_RUSH = {
    ...
    'level_req': 12, 'skill_req': 15, 'stamina_cost': 20, 'cooldown': 20.0, 'casting_time': 0.0, 'target_type': 'movement', 'range': 15,
...
STAGGERING_SWEEP = {
    ...
    'level_req': 16, 'skill_req': 20, 'stamina_cost': 40, 'cooldown': 15.0, 'casting_time': 0.0, 'target_type': 'cone', 'range': 'melee',
    'effects': [
...
HAMMER_TOSS = {
    ...
    'level_req': 20, 'skill_req': 25, 'stamina_cost': 30, 'cooldown': 25.0, 'casting_time': 1.0, 'target_type': 'single', 'range': 25,
    'effects': [
...
THUNDERCLAP = {
    ...
    'level_req': 32, 'skill_req': 40, 'stamina_cost': 45, 'cooldown': 20.0, 'casting_time': 0.0, 'target_type': 'self', 'range': 0,
    'effects': [
...
EARTHQUAKE = {
    ...
    'level_req': 36, 'skill_req': 45, 'stamina_cost': 80, 'cooldown': 45.0, 'casting_time': 0.0, 'target_type': 'aoe_ground', 'range': 20,
...
UNSTOPPABLE_ADVANCE = {
    ...
    'level_req': 44, 'skill_req': 55, 'stamina_cost': 20, 'cooldown': 90.0, 'casting_time': 0.0, 'target_type': 'self', 'range': 0,
...
METEOR_STRIKE = {
    ...
    'level_req': 48, 'skill_req': 60, 'stamina_cost': 80, 'cooldown': 60.0, 'casting_time': 1.0, 'target_type': 'aoe_ground', 'range': 25,
    'effects': [
...
CRIPPLING_WAVE = {
    ...
    'level_req': 52, 'skill_req': 65, 'stamina_cost': 60, 'cooldown': 30.0, 'casting_time': 0.0, 'target_type': 'line', 'range': 20,
    'effects': [
...
PULVERIZE = {
    ...
    'level_req': 60, 'skill_req': 75, 'stamina_cost': 100, 'cooldown': 120.0, 'casting_time': 1.5, 'target_type': 'single', 'range': 'melee',
    'effects': [
