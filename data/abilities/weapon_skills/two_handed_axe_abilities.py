...
BRUTAL_CHOP = {
    ...
    'level_req': 1, 'stamina_cost': 28, 'cooldown': 0.0, 'casting_time': 0.0, 'target_type': 'single', 'range': 'melee',
...
RECKLESS_SWING = {
    ...
    'level_req': 8, 'stamina_cost': 35, 'cooldown': 10.0, 'casting_time': 0.0, 'target_type': 'cone', 'range': 'melee',
    'effects': [
...
INTIMIDATING_SHOUT = {
    ...
    'level_req': 12, 'stamina_cost': 15, 'cooldown': 30.0, 'casting_time': 0.0, 'target_type': 'self', 'range': 0,
...
WHIRLWIND = {
    ...
    'level_req': 20, 'stamina_cost': 50, 'cooldown': 12.0, 'casting_time': 0.0, 'target_type': 'self', 'range': 0,
...
BERSERKER_RAGE = {
    ...
    'level_req': 32, 'stamina_cost': 20, 'cooldown': 90.0, 'casting_time': 0.0, 'target_type': 'self', 'range': 0,
    'effects': [
...
ARTERIAL_CUT = {
    ...
    'level_req': 36, 'stamina_cost': 35, 'cooldown': 20.0, 'casting_time': 0.0, 'target_type': 'single', 'range': 'melee',
...
EARTHSPLITTER = {
    ...
    'level_req': 40, 'stamina_cost': 60, 'cooldown': 25.0, 'casting_time': 1.0, 'target_type': 'line', 'range': 20,
...
TASTE_FOR_BLOOD = {
    ...
    'level_req': 44, 'stamina_cost': 0, 'cooldown': 0.0, 'casting_time': 0.0, 'target_type': 'self', 'range': 0,
...
DECAPITATE = {
    ...
    'level_req': 48, 'stamina_cost': 50, 'cooldown': 15.0, 'casting_time': 0.0, 'target_type': 'single', 'range': 'melee',
...
CYCLONE_OF_CARNAGE = {
    ...
    'level_req': 60, 'stamina_cost': 120, 'cooldown': 120.0, 'casting_time': 0.0, 'target_type': 'self', 'range': 0,
    'effects': [
