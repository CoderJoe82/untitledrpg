...
POWER_SHOT = {
    ...
    'level_req': 1, 'skill_req': 1, 'stamina_cost': 20, 'cooldown': 0.0, 'casting_time': 2.0, 'target_type': 'single', 'range': 38,
...
EXPLOSIVE_BOLT = {
    ...
    'level_req': 4, 'skill_req': 5, 'stamina_cost': 25, 'cooldown': 8.0, 'casting_time': 2.2, 'target_type': 'single', 'range': 38,
...
RELOAD_MECHANISM = {
    ...
    'level_req': 8, 'skill_req': 10, 'stamina_cost': 10, 'cooldown': 30.0, 'casting_time': 0.0, 'target_type': 'self', 'range': 0,
...
PINNING_SHOT = {
    ...
    'level_req': 12, 'skill_req': 15, 'stamina_cost': 20, 'cooldown': 20.0, 'casting_time': 1.0, 'target_type': 'single', 'range': 38,
...
BOLT_SPRAY = {
    ...
    'level_req': 16, 'skill_req': 20, 'stamina_cost': 45, 'cooldown': 12.0, 'casting_time': 1.5, 'target_type': 'cone', 'range': 15,
...
SERRATED_BOLT = {
    ...
    'level_req': 20, 'skill_req': 25, 'stamina_cost': 15, 'cooldown': 6.0, 'casting_time': 1.0, 'target_type': 'single', 'range': 38,
...
CALTROPS = {
    ...
    'level_req': 24, 'skill_req': 30, 'stamina_cost': 30, 'cooldown': 25.0, 'casting_time': 0.0, 'target_type': 'aoe_ground', 'range': 20,
...
HEAVY_REPEATER = {
    ...
    'level_req': 28, 'skill_req': 35, 'stamina_cost': 50, 'cooldown': 15.0, 'casting_time': 0.0, 'target_type': 'single', 'range': 38,
...
SHRAPNEL_BOMB = {
    ...
    'level_req': 32, 'skill_req': 40, 'stamina_cost': 40, 'cooldown': 30.0, 'casting_time': 0.5, 'target_type': 'aoe_ground', 'range': 25,
    'effects': [
...
DOUBLE_TAP = {
    ...
    'level_req': 36, 'skill_req': 45, 'stamina_cost': 20, 'cooldown': 45.0, 'casting_time': 0.0, 'target_type': 'self', 'range': 0,
...
SNIPERS_NEST = {
    ...
    'level_req': 40, 'skill_req': 50, 'stamina_cost': 15, 'cooldown': 5.0, 'casting_time': 1.0, 'target_type': 'self', 'range': 0,
...
GRAPPLING_BOLT = {
    ...
    'level_req': 44, 'skill_req': 55, 'stamina_cost': 20, 'cooldown': 40.0, 'casting_time': 0.0, 'target_type': 'aoe_ground', 'range': 30,
...
CLUSTER_BOMB = {
    ...
    'level_req': 48, 'skill_req': 60, 'stamina_cost': 80, 'cooldown': 60.0, 'casting_time': 2.5, 'target_type': 'aoe_ground', 'range': 35,
...
THE_JUGGERNAUT = {
    ...
    'level_req': 56, 'skill_req': 70, 'stamina_cost': 60, 'cooldown': 45.0, 'casting_time': 3.5, 'target_type': 'single', 'range': 45,
    'effects': [
...
BALLISTA_TURRET = {
    ...
    'level_req': 60, 'skill_req': 75, 'stamina_cost': 120, 'cooldown': 180.0, 'casting_time': 2.0, 'target_type': 'aoe_ground', 'range': 15,
