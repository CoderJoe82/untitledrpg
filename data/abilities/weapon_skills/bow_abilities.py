...
STEADY_SHOT = {
    ...
    'level_req': 1, 'skill_req': 1, 'stamina_cost': 15, 'cooldown': 0.0, 'casting_time': 1.5, 'target_type': 'single', 'range': 40,
...
SERPENT_STING = {
    ...
    'level_req': 4, 'skill_req': 5, 'stamina_cost': 20, 'cooldown': 6.0, 'casting_time': 0.0, 'target_type': 'single', 'range': 40,
...
DISENGAGE = {
    ...
    'level_req': 8, 'skill_req': 10, 'stamina_cost': 10, 'cooldown': 20.0, 'casting_time': 0.0, 'target_type': 'movement', 'range': 15,
...
AIMED_SHOT = {
    ...
    'level_req': 12, 'skill_req': 15, 'stamina_cost': 35, 'cooldown': 4.0, 'casting_time': 2.5, 'target_type': 'single', 'range': 40,
...
MULTI_SHOT = {
    ...
    'level_req': 16, 'skill_req': 20, 'stamina_cost': 40, 'cooldown': 8.0, 'casting_time': 0.0, 'target_type': 'cone', 'range': 35,
...
BARBED_ARROW = {
    ...
    'level_req': 20, 'skill_req': 25, 'stamina_cost': 25, 'cooldown': 10.0, 'casting_time': 0.0, 'target_type': 'single', 'range': 40,
...
CONCUSSIVE_SHOT = {
    ...
    'level_req': 24, 'skill_req': 30, 'stamina_cost': 15, 'cooldown': 15.0, 'casting_time': 0.0, 'target_type': 'single', 'range': 40,
...
HUNTERS_MARK = {
    ...
    'level_req': 28, 'skill_req': 35, 'stamina_cost': 10, 'cooldown': 3.0, 'casting_time': 0.0, 'target_type': 'single', 'range': 50,
...
VOLLEY = {
    ...
    'level_req': 32, 'skill_req': 40, 'stamina_cost': 60, 'cooldown': 45.0, 'casting_time': 0.0, 'target_type': 'aoe_ground', 'range': 40,
...
PIERCING_SHOT = {
    ...
    'level_req': 36, 'skill_req': 45, 'stamina_cost': 40, 'cooldown': 12.0, 'casting_time': 2.0, 'target_type': 'single', 'range': 40,
...
RAPID_FIRE = {
    ...
    'level_req': 40, 'skill_req': 50, 'stamina_cost': 30, 'cooldown': 90.0, 'casting_time': 0.0, 'target_type': 'self', 'range': 0,
...
BINDING_SHOT = {
    ...
    'level_req': 44, 'skill_req': 55, 'stamina_cost': 25, 'cooldown': 45.0, 'casting_time': 0.0, 'target_type': 'aoe_ground', 'range': 35,
...
MASTER_MARKSMAN = {
    ...
    'level_req': 48, 'skill_req': 60, 'stamina_cost': 0, 'cooldown': 0.0, 'casting_time': 0.0, 'target_type': 'self', 'range': 0,
...
KILL_SHOT = {
    ...
    'level_req': 52, 'skill_req': 65, 'stamina_cost': 20, 'cooldown': 8.0, 'casting_time': 0.0, 'target_type': 'single', 'range': 45,
...
TRUESHOT = {
    ...
    'level_req': 56, 'skill_req': 70, 'stamina_cost': 50, 'cooldown': 180.0, 'casting_time': 0.0, 'target_type': 'self', 'range': 0,
    'effects': [
...
WINDBURST = {
    ...
    'level_req': 60, 'skill_req': 75, 'stamina_cost': 75, 'cooldown': 45.0, 'casting_time': 1.5, 'target_type': 'single', 'range': 40,
    'effects': [
