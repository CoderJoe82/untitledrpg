...
SAVAGE_STRIKE = {
    ...
    'level_req': 1, 'stamina_cost': 22, 'cooldown': 0.0, 'casting_time': 0.0, 'target_type': 'single', 'range': 'melee',
...
RENDING_CHOP = {
    ...
    'level_req': 4, 'stamina_cost': 20, 'cooldown': 8.0, 'casting_time': 0.0, 'target_type': 'single', 'range': 'melee',
...
BATTLE_TRANCE = {
    ...
    'level_req': 8, 'stamina_cost': 15, 'cooldown': 45.0, 'casting_time': 0.0, 'target_type': 'self', 'range': 0,
...
THROWING_AXE = {
    ...
    'level_req': 12, 'stamina_cost': 10, 'cooldown': 6.0, 'casting_time': 0.0, 'target_type': 'single', 'range': 25,
...
MUTILATE = {
    ...
    'level_req': 16, 'stamina_cost': 30, 'cooldown': 6.0, 'casting_time': 0.0, 'target_type': 'single', 'range': 'melee',
...
WIDE_SWING = {
    ...
    'level_req': 20, 'stamina_cost': 35, 'cooldown': 10.0, 'casting_time': 0.0, 'target_type': 'cone', 'range': 'melee',
...
OVERWHELM = {
    ...
    'level_req': 28, 'stamina_cost': 25, 'cooldown': 12.0, 'casting_time': 0.0, 'target_type': 'single', 'range': 'melee',
...
GUSHING_WOUND = {
    ...
    'level_req': 32, 'stamina_cost': 40, 'cooldown': 18.0, 'casting_time': 0.0, 'target_type': 'single', 'range': 'melee',
...
RAMPAGE = {
    ...
    'level_req': 36, 'stamina_cost': 20, 'cooldown': 90.0, 'casting_time': 0.0, 'target_type': 'self', 'range': 0,
    'effects': [
...
DEEP_GOUGE = {
    ...
    'level_req': 40, 'stamina_cost': 35, 'cooldown': 15.0, 'casting_time': 0.0, 'target_type': 'single', 'range': 'melee',
...
SHATTER_DEFENSES = {
    ...
    'level_req': 44, 'stamina_cost': 25, 'cooldown': 30.0, 'casting_time': 0.0, 'target_type': 'single', 'range': 'melee',
...
DECAPITATE = {
    ...
    'level_req': 48, 'stamina_cost': 50, 'cooldown': 8.0, 'casting_time': 0.0, 'target_type': 'single', 'range': 'melee',
...
DEATH_WISH = {
    ...
    'level_req': 56, 'stamina_cost': 10, 'cooldown': 120.0, 'casting_time': 0.0, 'target_type': 'self', 'range': 0,
    'effects': [
...
EXECUTIONERS_CHOP = {
    ...
    'level_req': 60, 'stamina_cost': 80, 'cooldown': 45.0, 'casting_time': 1.5, 'target_type': 'single', 'range': 'melee',
