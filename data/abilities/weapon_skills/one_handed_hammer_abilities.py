...
SHATTER_ARMOR = {
    ...
    'level_req': 4, 'skill_req': 5, 'stamina_cost': 15, 'cooldown': 0.0, 'casting_time': 0.0, 'target_type': 'single', 'range': 'melee',
...
DAZING_BLOW = {
    ...
    'level_req': 8, 'skill_req': 10, 'stamina_cost': 25, 'cooldown': 18.0, 'casting_time': 0.0, 'target_type': 'single', 'range': 'melee',
...
SHIELD_BASH = {
    ...
    'level_req': 12, 'skill_req': 15, 'stamina_cost': 10, 'cooldown': 12.0, 'casting_time': 0.0, 'target_type': 'single', 'range': 'melee',
    'effects': [
...
CRUSHING_BLOW = {
    ...
    'level_req': 16, 'skill_req': 20, 'stamina_cost': 35, 'cooldown': 8.0, 'casting_time': 0.0, 'target_type': 'single', 'range': 'melee',
...
GROUND_SLAM = {
    ...
    'level_req': 20, 'skill_req': 25, 'stamina_cost': 40, 'cooldown': 15.0, 'casting_time': 0.0, 'target_type': 'cone', 'range': 6,
    'effects': [
...
CONCUSS = {
    ...
    'level_req': 24, 'skill_req': 30, 'stamina_cost': 20, 'cooldown': 12.0, 'casting_time': 0.0, 'target_type': 'single', 'range': 'melee',
...
BONEBREAKER = {
    ...
    'level_req': 28, 'skill_req': 35, 'stamina_cost': 0, 'cooldown': 0.0, 'casting_time': 0.0, 'target_type': 'self', 'range': 0,
...
ARMOR_COLLAPSE = {
    ...
    'level_req': 36, 'skill_req': 45, 'stamina_cost': 40, 'cooldown': 60.0, 'casting_time': 0.0, 'target_type': 'single', 'range': 'melee',
...
PUNISH = {
    ...
    'level_req': 40, 'skill_req': 50, 'stamina_cost': 35, 'cooldown': 10.0, 'casting_time': 0.0, 'target_type': 'single', 'range': 'melee',
...
UNYIELDING = {
    ...
    'level_req': 44, 'skill_req': 55, 'stamina_cost': 20, 'cooldown': 120.0, 'casting_time': 0.0, 'target_type': 'self', 'range': 0,
...
SKULLCRACKER = {
    ...
    'level_req': 48, 'skill_req': 60, 'stamina_cost': 60, 'cooldown': 20.0, 'casting_time': 1.0, 'target_type': 'single', 'range': 'melee',
...
EARTHSHATTER = {
    ...
    'level_req': 60, 'skill_req': 75, 'stamina_cost': 100, 'cooldown': 120.0, 'casting_time': 1.5, 'target_type': 'self', 'range': 0,
    'effects': [
